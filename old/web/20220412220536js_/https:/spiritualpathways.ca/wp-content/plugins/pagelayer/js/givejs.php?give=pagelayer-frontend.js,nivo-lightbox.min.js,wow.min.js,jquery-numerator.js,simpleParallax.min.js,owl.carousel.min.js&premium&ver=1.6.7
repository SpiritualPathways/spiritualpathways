...
function pagelayer_recaptcha_loader(jEle, loadScript){
	...
	if(pagelayer_empty(window.grecaptcha) && !pagelayer_empty(loadScript)){
		jQuery('body').append('<script src="https://web.archive.org/web/20231121171018/https://www.google.com/recaptcha/api.js?render=explicit'+reParam+'" async defer></script>');
	}
...
/*
     FILE ARCHIVED ON 17:10:18 Nov 21, 2023 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 17:10:24 Nov 21, 2023.
...
/*
playback timings (ms):
  captures_list: 335.117
  exclusion.robots: 0.182
  exclusion.robots.policy: 0.166
  cdx.remote: 0.077
  esindex: 0.01
  LoadShardBlock: 254.354 (3)
  PetaboxLoader3.datanode: 75.909 (3)
  PetaboxLoader3.resolve: 157.633
  load_resource: 64.241
*/